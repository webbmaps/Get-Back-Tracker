   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "2025-05-10 16:35:24.523 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
      "2025-05-10 16:35:24.524 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
      "2025-05-10 16:35:24.524 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n",
      "2025-05-10 16:35:24.525 Thread 'MainThread': missing ScriptRunContext! This warning can be ignored when running in bare mode.\n"
     ]
    }
   ],
   "source": [
    ...
    "    basemap= None)\n",
    "\n",
    "trails= 'https://raw.githubusercontent.com/webbmaps/Get-Back-Tracker/refs/heads/main/trails.geojson'\n",
    "lusk= 'https://raw.githubusercontent.com/webbmaps/Get-Back-Tracker/refs/heads/main/lusk.geojson'\n",
    "vis={\n",
    "    'color': 'brown',\n",
    "    'weight': 1\n",
    "}\n",
